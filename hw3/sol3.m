...
runTimes=zeros(1,5);
    ...
    legend('MP','OMP','LS-OMP','Weak-MP(t=0.5)','lasso','Location','northwest')
    set(gca,'FontSize',15,'FontWeight','Bold');
    saveas(gca, ['./eps/' 'l2.eps'] ,'epsc');
    
    figure;
    plot(axis_supp_num,err2_MP_mean,'-',axis_supp_num,err2_OMP_mean,'--',axis_supp_num,err2_LSOMP_mean,':',axis_supp_num,err2_WMP_mean,'-.',axis_supp_num,err2_lasso_mean,'+-','LineWidth',2);
...
set(gca,'XTickLabel',{'MP','OMP','LS-OMP','Weak-MP(t=0.5)','lasso'})
